...
<main id="main" role="main" class="main-content">
    <div class="container-fluid">
        ...
        <div class="read-moresec">
            <a href="<?php echo esc_url( home_url() ); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Return to the home page', 'ultimate-ecommerce-shop' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to the home page','ultimate-ecommerce-shop' );?></span></a>
        </div>
