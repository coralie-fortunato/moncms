...
*/
?>
<div class="<?php if( get_theme_mod( 'ultimate_ecommerce_shop_sticky_header') != '') { ?> sticky-menubox"<?php } else { ?>close-sticky <?php } ?>">
  <div class="header">
      ...
      <div class="row m-0">
        ...
        <div class="col-lg-8 col-md-6 col-5">
          <div class="menubox">
            <div class="toggle-menu responsive-menu">
              <button role="tab" onclick="ultimate_ecommerce_shop_resMenu_open()"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ultimate-ecommerce-shop'); ?></span></button>
            </div>
        ...
        <div class="search-box col-lg-2 col-md-3 col-7 cart_links">
          ...
          <div class="serach_outer">
            ...
            <div class="closepop"><a href="#cart"><i class="far fa-window-close"></i></a></div>
          </div>
